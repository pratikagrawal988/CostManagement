        ...
        <div style={{ flex: 1, display: 'flex', minWidth: 0, overflow: 'hidden' }}>
          ...
          <aside style={{
            ...
            <div>
              ...
              <Scenario tone="positive" label="Best case" amt="$2.41M" pctV={-3.2}
                        body="Reclaim 84 idle gp3 volumes · scale spot-3 to 14n · close 18 zombie BQ schedules" />
              <Scenario tone="neutral"  label="Likely" amt="$2.54M" pctV={1.9}
                        body="Current burn rate continues. Includes May 23 ML training run." selected />
              <Scenario tone="negative" label="Worst case" amt="$2.71M" pctV={8.8}
...
function Scenario({ tone, label, amt, pctV, body, selected }) {
  return (
    <div style={{
